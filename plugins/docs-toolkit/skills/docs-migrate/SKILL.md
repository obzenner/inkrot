...
|--------|--------|--------------|
| Directory name matches schema defaults | HIGH | Check against discovery defaults below |
| Filename matches schema naming pattern | HIGH | Match against schema naming regex |
...
| "Timeline", "Impact", "Root Cause", "Remediation", "Prevention" | Learnings (incident) |
| "Context", "What Went Well", "What Didn't", "Action Items" | Learnings (retrospective) |
| "Discovery", "Context", "Implication", "References" | Learnings (til) |
| "Problem", "Proposal", "Alternatives", "Resolution" | Rfc |
| "Purpose", "Prerequisites", "Steps", "Rollback", "Escalation" | Runbook |
| "User Scenarios", "Requirements", "Success Criteria", "Assumptions" | Spec |
| "Phases", "Task Items", "Dependencies" | Tasks |
