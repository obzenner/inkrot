...
| Type | Valid Statuses |
|------|---------------|
| Adr | accepted, deprecated, proposed, rejected, superseded |
| Learnings | archived, draft, published |
| Rfc | accepted, draft, open, rejected, withdrawn |
| Runbook | active, deprecated, draft |
| Spec | abandoned, approved, draft, implemented |
| Tasks | abandoned, active, completed |
